...
{ 
    ...
    {
        CharacterControllerCharacter character = Object.Instantiate(config.CharacterControllerCharacterPrefab, spawnPosition, Quaternion.identity);
    ...
    {
        AgentEnemyCharacter character = Object.Instantiate(config.AgentEnemyCharacterPrefab, spawnPosition, Quaternion.identity);
